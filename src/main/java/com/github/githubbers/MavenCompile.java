        ...
        if (pomPath != null)
        {
            ...
            try
            {
                ...
                if (invocationResult.getExitCode() == 0)
                {
                    ...
                    {
                        LogOutput.saveFile(RepoDetails.getMatricNo(repoUrl), repoName, output.toString());
            ...
            {
                LogOutput.saveFile(RepoDetails.getMatricNo(repoUrl), repoName, repoName + " No pom.xml file!");
